...
void
WifiMac::SetRxDropCallback(MacRxDropCallback callback)
{
  m_rxDropCallback = callback;
}

void
WifiMac::SetTxDropCallback(MacTxDropCallback callback)
{
