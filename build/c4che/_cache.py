...
CFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.6-e9shER/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.6-e9shER/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
...
CXXFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.6-e9shER/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.6-e9shER/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['routing', 'wireless', 'tcp', 'tutorial', 'matrix-topology', 'traffic-control', 'channel-models', 'realtime', 'udp-client-server', 'error-model', 'energy', 'ipv6', 'socket', 'udp', 'naming', 'stats']
...
LIBPATH_ST = '-L%s'
LIB_BOOST = ['boost_system', 'boost_signals', 'boost_filesystem.so.1.65']
LIB_GCRYPT = ['gcrypt']
...
NS3_EXECUTABLE_PATH = ['/home/caleb/Software/svntrees/ns3/ns-allinone-3.33/ns-3.33/build/src/fd-net-device', '/home/caleb/Software/svntrees/ns3/ns-allinone-3.33/ns-3.33/build/src/tap-bridge']
...
VERSION = '3.33'
WITH_PYBINDGEN = '/home/caleb/Software/svntrees/ns3/ns-allinone-3.33/pybindgen-0.21.0.post15+nga587377'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/caleb/Software/svntrees/ns3/ns-allinone-3.33/ns-3.33/build/ns3/config-store-config.h', '/home/caleb/Software/svntrees/ns3/ns-allinone-3.33/ns-3.33/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
