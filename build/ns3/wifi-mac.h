...
typedef Callback<void, Ptr<const Packet>> MacRxDropCallback;
typedef Callback<void, Ptr<const Packet>> MacTxDropCallback;
...
public:
  ...
  void SetRxDropCallback (MacRxDropCallback callback);

  void SetTxDropCallback (MacTxDropCallback callback);
...
private:
  ...
  MacRxDropCallback m_rxDropCallback;
  MacTxDropCallback m_txDropCallback;
